...
export const translations = {
  zh: {
    ...
    hero: {
      ...
      subtitleLine2: '描述你的目标，AI Agent 自动规划并执行。遇到问题？即时分析解决。',
      downloadBtn: '立即下载',
      viewSourceBtn: '查看源码',
  ...
  en: {
    ...
    hero: {
      ...
      subtitleLine2: 'Describe your goal, AI Agent plans and executes automatically. Problems? Instant analysis and solutions.',
