...
const translations = {
  'zh-CN': {
    ...
    'agent.user_supplement_with_plan': '[系统提示：用户补充了新信息。如果这影响到当前计划，你可以用 clear_plan + create_plan 调整计划，或用 update_plan 跳过/修改步骤。如果不影响，继续执行即可。]',
...
[系统/任务的当前状态]`,
  ...
  'en-US': {
    ...
    'agent.user_supplement_with_plan': '[System: User provided new info. If it affects the plan, use clear_plan + create_plan to adjust, or update_plan to skip/modify steps. Otherwise, continue as planned.]',
