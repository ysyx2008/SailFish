#!/usr/bin/env node
/**
 * CT-Transformer 标点恢复模型下载脚本
 * 下载 sherpa-onnx-punct-ct-transformer-zh-en-vocab272727-2024-04-12-int8 模型（约 72MB）
 */
...
const MODEL_DIR = path.join(__dirname, '..', 'resources', 'models', 'speech', 'punctuation')
const MODEL_NAME = 'sherpa-onnx-punct-ct-transformer-zh-en-vocab272727-2024-04-12-int8'
const MODEL_URL = `https://github.com/k2-fsa/sherpa-onnx/releases/download/punctuation-models/${MODEL_NAME}.tar.bz2`
...
async function main() {
  console.log('==================================================')
  console.log('CT-Transformer Punctuation Model Downloader')
  console.log('==================================================')
  console.log()
