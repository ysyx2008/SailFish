export default {
  ...
  settings: {
    ...
    im: {
      ...
      wecomEncodingAESKey: 'Callback EncodingAESKey',
      wecomCallbackPort: 'Callback Port',
      wecomHint: 'Create a self-built app in WeCom Admin Console and configure the message callback. The callback URL must be accessible from the internet.',
      wecomStep1: 'Log in to WeCom Admin Console (work.weixin.qq.com) and create a self-built app',
      wecomStep2: 'Get the AgentId and Secret from the app details page',
      wecomStep3: 'Configure the callback URL in "Receive Messages" (http://<public-address>:<port>/wecom/callback)',
      wecomStep4: 'Enter the Token, EncodingAESKey and Corp ID below',
      ...
      guideWecomStep1: 'Log in to WeCom Admin Console (work.weixin.qq.com), go to "App Management" and create a self-built app',
      guideWecomStep2: 'Get AgentId and Secret from the app details page, and Corp ID from "My Enterprise"',
      guideWecomStep3: 'Configure callback URL, Token, and EncodingAESKey in "Receive Messages"',
      guideWecomStep4: 'Callback URL format: http://<public-IP-or-domain>:<port>/wecom/callback (port must be accessible from the internet)',
      guideWecomStep5: 'Enter credentials above and click Connect. Then save the callback configuration in WeCom console',
