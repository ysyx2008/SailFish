export default {
  ...
  settings: {
    ...
    im: {
      ...
      guideDocUrlTelegram: 'https://github.com/ysyx2008/SFTerminal/blob/main/docs/messaging/telegram.md',
      guideDocUrlWecom: 'https://github.com/ysyx2008/SFTerminal/blob/main/docs/messaging/wecom.md',
