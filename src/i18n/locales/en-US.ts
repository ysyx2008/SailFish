export default {
  ...
  awaken: {
    title: 'Awakening',
    description: 'When enabled, AI becomes proactive — periodically scanning your calendar, emails, and watches, reaching out when something needs your attention.',
    enable: 'Awakening Mode',
    enableDesc: 'Transform AI from passive tool to proactive assistant',
    interval: 'Patrol Interval (minutes)',
    intervalDesc: 'How often to scan the environment. Recommended 30-60 minutes',
    manualTrigger: 'Patrol Now',
    manualTriggerDesc: 'Trigger an immediate environment scan',
    trigger: 'Patrol',
    running: 'Awakened',
    stopped: 'Dormant',
