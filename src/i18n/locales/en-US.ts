export default {
  ...
  awaken: {
    ...
    identityPlaceholder: 'I am a pragmatic tech partner, skilled in backend development and system operations.\nMy style is direct and to the point.',
    ...
    personalityPlaceholder: 'Style: Lead with conclusions, be direct, no fluff\nThinking: Analyze root causes before jumping to solutions\nBoundaries: Say "I\'m not sure" when uncertain, never fabricate\nAttitude: Challenge bad ideas openly, express disagreement clearly',
    ...
    userProfilePlaceholder: 'Name: Yu\nRole: Backend developer\nUse cases: Daily development, server operations\nPreferences: Concise and direct',
    mbtiNav: 'MBTI Style',
