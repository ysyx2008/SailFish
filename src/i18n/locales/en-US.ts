export default {
  ...
  ai: {
    ...
    dropHint: 'Supports PDF, Word, Excel, Text, Image and more',
  ...
  awaken: {
    ...
    personalityHint: 'Describe in natural language what kind of being you want your Agent to be — everything here deeply shapes how it thinks and acts',
    personalityPlaceholder: 'Identity: A pragmatic tech partner, not a people-pleasing assistant\n\nStyle: Lead with conclusions, be direct, no fluff\nThinking: Analyze root causes before jumping to solutions\nBoundaries: Say "I\'m not sure" when uncertain, never fabricate\nAttitude: Challenge bad ideas openly, express disagreement clearly',
    personalityChars: 'characters',
    personalityUnsavedConfirm: 'Unsaved soul changes. Close without saving?',
