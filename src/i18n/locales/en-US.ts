export default {
  ...
  settings: {
    ...
    im: {
      ...
      guideDesc: 'Once connected, find the bot in DingTalk or Feishu and send a message to start chatting with the AI Agent.',
      guideFeatures: 'Capabilities',
      guideFeature1: 'Execute commands in the local terminal (deploy, troubleshoot, manage files)',
      guideFeature2: 'Read, write, and edit local files',
      guideFeature3: 'Answer technical questions and provide suggestions',
      guideFeature4: 'Support multi-turn conversations with context awareness',
      guideCommands: 'Built-in Commands',
      ...
      guideConfirmTitle: 'Operation Confirmation',
      guideConfirmDesc: 'In strict or relaxed mode, the Agent will ask for confirmation before executing certain commands. Reply in IM:',
      guideConfirmApprove: 'Approve execution',
      guideConfirmReject: 'Reject operation'
    }
  },
