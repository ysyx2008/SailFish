export default {
  ...
  settings: {
    ...
    im: {
      ...
      guideTitle: '使用说明',
      guideDesc: '连接成功后，在钉钉或飞书中找到该机器人，直接发消息即可与 AI Agent 对话。',
      guideFeatures: '支持的能力',
      guideFeature1: '在本机终端执行命令（如部署、排查问题、管理文件）',
      guideFeature2: '读写和编辑本机文件',
      guideFeature3: '回答技术问题，提供操作建议',
      guideFeature4: '支持多轮连续对话，理解上下文',
      guideCommands: '内置命令',
      guideCommandHelp: '显示帮助信息',
      guideCommandStatus: '查看当前会话状态',
      guideCommandClear: '清空对话历史',
      guideConfirmTitle: '操作确认',
      guideConfirmDesc: '在严格或宽松模式下，Agent 执行某些命令前会请求你确认。在 IM 中回复：',
      guideConfirmApprove: '批准执行',
      guideConfirmReject: '拒绝操作'
    }
  },
