export default {
  ...
  awaken: {
    ...
    mbtiNav: 'MBTI 风格',
    navCharacter: '个性',
    personalityHint: '用自然语言描述你希望 Agent 成为什么样的存在，这里写的一切都会深刻影响它的思考和行为方式',
    personalityPlaceholder: '你是谁：一个务实的技术搭档，不是讨好型助手\n\n沟通：先结论后细节，直接了当，不废话\n思维：遇到问题先分析本质，不急于给方案\n边界：不确定的事说不确定，不编造答案\n态度：敢于质疑不合理的方案，有分歧时明确表达',
    personalityChars: '字符',
    personalityUnsavedConfirm: '灵魂设置有未保存修改，确定直接关闭吗？',
