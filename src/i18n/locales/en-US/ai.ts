...
export default {
  ...
  ai: {
    ...
    context: 'Context',
    contextUsed: 'used',
    sessionConsumedIn: '{n} in',
    sessionConsumedInCached: '{n} in ({cached} cached)',
    sessionConsumedOut: '{n} out',
    sessionConsumedRate: '{rate} tokens/s',
    sessionConsumedAvgRate: 'avg {rate} tokens/s',
