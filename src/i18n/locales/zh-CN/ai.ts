  ...
  ai: {
    ...
    approvalMode: {
      ...
      strict: {
        label: '每步都问',
        desc: '每个操作都要你点头',
        tip: '每个操作都停下来等你点头。适合敏感环境，你要盯着每一步。',
      },
      relaxed: {
        label: '只问危险的',
        desc: '安全的自己做，危险的问你',
        tip: '安全的自己做。删文件、改系统这类危险操作才问你。日常用这个。',
      },
      autoReview: {
        label: '替我审批',
        desc: '危险的先对照你说过的话看，没把握再问你',
        tip: '和「只问危险的」一样，但危险的会先对照你说过的话看一眼。能放行就替你过；没把握还是问你。它只能替你放行，不会替你拒绝。',
      },
      free: {
        label: '不问，直接做',
        desc: '全部自动，包括危险操作',
        tip: '全部自动做，包括危险操作。有风险，只在你完全放心时用。',
      },
    },
